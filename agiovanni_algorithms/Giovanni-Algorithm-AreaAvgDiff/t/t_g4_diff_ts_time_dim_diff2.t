...
# where the time values are the same, but the bounds are different.
##
...
my ( $out_nc, $diff_rc ) = run_test(
    ...
    'temp_res' => '3-hourly',
    'diff-exclude' => [
        qw(difference/lat_bnds difference/lon_bnds difference/dataday /calendar /center /model difference/grid_name difference/grid_type difference/level_description difference/product_short_name difference/time_statistic difference/vmax)
    ]
);
...
// global attributes:
		...
		:userenddate = "2000-01-01T05:59:50Z" ;
data:
 ...
 time_GLDAS_NOAH025_3H_2_0_RootMoist_inst = 946684800, 946695600 ;
