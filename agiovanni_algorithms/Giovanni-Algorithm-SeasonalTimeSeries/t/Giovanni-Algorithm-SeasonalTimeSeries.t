#$Id: Giovanni-Algorithm-SeasonalTimeSeries.t,v 1.5 2015/04/23 19:53:57 csmit Exp $
...
variables:
    ...
    float TRMM_3B43_007_precipitation(time) ;
        ...
        TRMM_3B43_007_precipitation:cell_methods = "lat, lon: mean time: mean" ;
        TRMM_3B43_007_precipitation:group_type = "SEASON" ;
        TRMM_3B43_007_precipitation:group_value = "DJF" ;
...
// global attributes:
        ...
        :temporal_resolution = "monthly" ;
        :NCO = "\"4.5.3\"" ;
	:geospatial_lat_max = "0.375" ;
	:geospatial_lat_min = "-0.375" ;
	:geospatial_lon_max = "0.375" ;
	:geospatial_lon_min = "-0.375" ;

data:

 datayear = 2000, 2001, 2002 ;

 time = 944006400, 975628800, 1007164800 ;

 TRMM_3B43_007_precipitation = 0.2395054, 0.1251829, 0.1077742 ;
}
