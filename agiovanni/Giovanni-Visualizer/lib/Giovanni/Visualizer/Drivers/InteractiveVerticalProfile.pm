package Giovanni::Visualizer::Drivers::InteractiveVerticalProfile;
...
Giovanni::Visualizer::Drivers::InteractiveVerticalProfile - prepares data for InteractiveVerticalProfile plot

=head1 SYNOPSIS

use Giovanni::Visualizer::Drivers::InteractiveVerticalProfile;

$driver = new Giovanni::Visualizer::Drivers::InteractiveVerticalProfile();
...
sub visualize {
    ...
    foreach my $inFile ( keys %{ $visualizerParams->{dataFiles} } ) {
        ...
        my $dataUrl = "daac-bin/netcdf_serializer_general.pl?" . $urlQuery;
