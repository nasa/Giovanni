package Giovanni::Visualizer::Drivers::InteractiveTimeSeries;
...
Giovanni::Visualizer::Drivers::InteractiveTimeSeries - prepares data for InteractiveTimeSeries plot

=head1 SYNOPSIS

use Giovanni::Visualizer::Drivers::InteractiveTimeSeries;

$driver = new Giovanni::Visualizer::Drivers::InteractiveTimeSeries();
...
Prepares data for InteractiveTimeSeries plot
...
sub visualize {
    ...
    foreach my $inFile ( keys %{ $visualizerParams->{dataFiles} } ) {
        ...
        my $dataUrl = "daac-bin/netcdf_json_serializer.pl?" . $urlQuery;
