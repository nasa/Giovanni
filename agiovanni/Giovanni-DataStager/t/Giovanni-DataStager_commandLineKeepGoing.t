#$Id: Giovanni-DataStager_commandLineKeepGoing.t,v 1.2 2014/12/23 20:08:02 csmit Exp $
...
my $cmd
    ...
    . "--chunk-size 10 --cache-root-path $cacheRoot --no-stderr --keep-going "
...
# and check for the bad url file
ok( -f "$sessionDir/$outfilename" . "_BAD_URLS.txt",
    "Bad URLs file present" );
