#$Id: Giovanni-DataStager_fileCache.t,v 1.4 2014/12/23 20:08:02 csmit Exp $
...
my $topDir = tempdir(CLEANUP => 1, DIR=> $ENV{TMPDIR});
...
<?xml version="1.0"?>
<searchList><search id="GSSTFM_3_SET1_INT_ST_mag"><result url="http://measures.gsfc.nasa.gov/opendap/GSSTF/GSSTFM.3/2003/GSSTFM.3.2003.01.01.he5.nc?SET1_INT_STu[0:719][0:1439],SET1_INT_STv[0:719][0:1439],lat[0:719],lon[0:1439]" filename="GSSTFM.3.2003.01.01.he5.nc"/><result url="http://measures.gsfc.nasa.gov/opendap/GSSTF/GSSTFM.3/2003/GSSTFM.3.2003.02.01.he5.nc?SET1_INT_STu[0:719][0:1439],SET1_INT_STv[0:719][0:1439],lat[0:719],lon[0:1439]" filename="GSSTFM.3.2003.02.01.he5.nc"/><result url="http://measures.gsfc.nasa.gov/opendap/GSSTF/GSSTFM.3/2003/GSSTFM.3.2003.03.01.he5.nc?SET1_INT_STu[0:719][0:1439],SET1_INT_STv[0:719][0:1439],lat[0:719],lon[0:1439]" filename="GSSTFM.3.2003.03.01.he5.nc"/></search></searchList>
SEARCH
...
# create a file cacher
my $cacheDir = "$topDir/cache";
mkdir($cacheDir);
...
# create two fake files for the fake cache
my $tempDir = "$topDir/temp";
mkdir($tempDir);

# NOTE: these keys are derived from the first and third entries in the search
my @filenames = ( "first.nc", "third.nc" );
my @keys = (
    "file://measures.gsfc.nasa.gov/opendap/GSSTF/GSSTFM.3/2003/GSSTFM.3.2003.01.01.he5.nc?SET1_INT_STu[0:719][0:1439],SET1_INT_STv[0:719][0:1439],lat[0:719],lon[0:1439]#GSSTFM_3_SET1_INT_ST_mag",
...
is( scalar(@files), 3, "Three files created." );
for my $file (@files) {
