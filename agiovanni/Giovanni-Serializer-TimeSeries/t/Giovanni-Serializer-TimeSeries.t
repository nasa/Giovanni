#!/usr/bin/env perl
#$Id: Giovanni-Serializer-TimeSeries.t,v 1.3 2013/11/08 22:09:00 csmit Exp $
...
my $url
    = "http://s4ptu-ts2.ecs.nasa.gov/~csmit/giovanni/#service=AREA_AVERAGED_TIME_SERIES&starttime=2003-01-01T00:00:00Z&endtime=2003-01-05T00:59:59Z&bbox=-180,-90,180,90&data=MOD08_D3_051_Optical_Depth_Land_And_Ocean_Mean&variableFacets=parameterMeasurement%3ATotal%20Aerosol%20Optical%20Depth%3BdataProductInstrumentShortName%3AMODIS%3B";
...
ok( $csvText =~ m/2003-01-01 00:00:00,0.160728/, "first data point correct" );
ok( $csvText =~ m/2003-01-02 00:00:00,0.160121/, "first data point correct" );
ok( $csvText =~ m/2003-01-03 00:00:00,0.163620/, "first data point correct" );
ok( $csvText =~ m/2003-01-04 00:00:00,0.162991/, "first data point correct" );
ok( $csvText =~ m/2003-01-05 00:00:00,0.167412/, "first data point correct" );
...
data:
 ...
 MOD08_D3_051_Optical_Depth_Land_And_Ocean_Mean = 0.160728456729218, 
    0.160121114125927, 0.163620193330985, 0.162991210702406, 0.167412285815492 ;
