...
# Ed Seiler changed dataProductStartTimeOffset from 1 to 0 to compensate
# for CMR OpenSearch bug that expects offset=0 instead of offset=1
...
<var id="MOD08_D3_6_1_Cloud_Optical_Thickness_Combined_Mean" long_name="Combined Cloud Optical Thickness: Mean of Daily Mean" searchIntervalDays="365.0" sampleOpendap="https://ladsweb.modaps.eosdis.nasa.gov/opendap/allData/61/MOD08_D3/2000/055/MOD08_D3.A2000055.061.2017276160246.hdf.html" dataProductTimeFrequency="1" accessFormat="netCDF" north="90.0" accessMethod="OPeNDAP" endTime="2038-01-19T03:14:07Z" url="https://giovanni-test.gesdisc.eosdis.nasa.gov/daac-bin/SSW/SSW?action=SUBSET;no_attr_prefix=1;content_key_is_value=1;force_array=1;pretty=0;format=netCDF;dataset_id=MODIS%2FTerra%20Aerosol%20Cloud%20Water%20Vapor%20Ozone%20Daily%20L3%20Global%201Deg%20CMG%20V6.1;agent_id=OPeNDAP;variables=Cloud_Optical_Thickness_Combined_Mean" startTime="2000-02-24T00:00:00Z" responseFormat="netCDF" south="-90.0" dataProductTimeInterval="daily" dataProductVersion="6.1" nominalMin="1.0" sampleFile="https://ladsweb.modaps.eosdis.nasa.gov/archive/allData/61/MOD08_D3/2000/055/MOD08_D3.A2000055.061.2017276160246.hdf" east="180.0" validMin="0.0" dataProductShortName="MOD08_D3" osdd="https://cmr.earthdata.nasa.gov/opensearch/granules/descriptor_document.xml?dataCenter=LAADS&amp;shortName=MOD08_D3&amp;versionId=6.1&amp;clientId=giovanni" resolution="1 deg." dataProductPlatformInstrument="MODIS-Terra" quantity_type="Cloud Properties" nominalMax="70.0" dataFieldStandardName="Cloud Optical Thickness" dataProductEndDateTime="2038-01-19T03:14:07Z" searchFilter="https:\/\/ladsweb\.modaps\.eosdis\.nasa\.gov\/archive\/allData\/61\/MOD08_D3" dataFieldUnitsValue="" latitudeResolution="1.0" accessName="Cloud_Optical_Thickness_Combined_Mean" fillValueFieldName="_FillValue" valuesDistribution="linear" accumulatable="false" spatialResolutionUnits="deg." dataProductStartTimeOffset="1" longitudeResolution="1.0" validMax="150.0" dataProductEndTimeOffset="0" oddxDims="&lt;opt&gt;&#10;  &lt;_LAT_DIMS name=&quot;YDim&quot; offset=&quot;0&quot; scaleFactor=&quot;1&quot; size=&quot;180&quot; /&gt;&#10;  &lt;_LAT_LONG_INDEXES&gt;0&lt;/_LAT_LONG_INDEXES&gt;&#10;  &lt;_LAT_LONG_INDEXES&gt;179&lt;/_LAT_LONG_INDEXES&gt;&#10;  &lt;_LAT_LONG_INDEXES&gt;0&lt;/_LAT_LONG_INDEXES&gt;&#10;  &lt;_LAT_LONG_INDEXES&gt;359&lt;/_LAT_LONG_INDEXES&gt;&#10;  &lt;_LONG_DIMS name=&quot;XDim&quot; offset=&quot;0&quot; scaleFactor=&quot;1&quot; size=&quot;360&quot; /&gt;&#10;  &lt;_VARIABLE_DIMS&gt;&#10;    &lt;Cloud_Optical_Thickness_Combined_Mean maxind=&quot;179&quot; name=&quot;YDim&quot; /&gt;&#10;    &lt;Cloud_Optical_Thickness_Combined_Mean maxind=&quot;359&quot; name=&quot;XDim&quot; /&gt;&#10;  &lt;/_VARIABLE_DIMS&gt;&#10;&lt;/opt&gt;&#10;" west="-180.0" sdsName="Cloud_Optical_Thickness_Combined_Mean" timeIntvRepPos="start" dataProductBeginDateTime="2000-02-24T00:00:00Z">
    <slds>
      <sld url="https://dev.gesdisc.eosdis.nasa.gov/giovanni/sld/land_surface_temp_sld.xml" label="Cyan-Red-Yellow (Seq), 65"/>
      <sld url="https://dev.gesdisc.eosdis.nasa.gov/giovanni/sld/co_sld.xml" label="Yellow-Orange-Red (Seq), 65"/>
    </slds>
...
is( $name, $out_file, "manifest files has the correct name");
...
@nodes
    = $xpc->findnodes(
    qq(searchList/search[\@id="MOD08_D3_6_1_Cloud_Optical_Thickness_Combined_Mean"]/result)
    );
@urls      = map { $_->getAttribute("url"); } @nodes;
@filenames = map { $_->getAttribute("filename"); } @nodes;

is_deeply(
    \@urls,
    [ "https://ladsweb.modaps.eosdis.nasa.gov:443/opendap/allData/61/MOD08_D3/2003/001/MOD08_D3.A2003001.061.2017281195411.hdf.nc?Cloud_Optical_Thickness_Combined_Mean[0:179][0:359],XDim[0:359],YDim[0:179]",
        "https://ladsweb.modaps.eosdis.nasa.gov:443/opendap/allData/61/MOD08_D3/2003/002/MOD08_D3.A2003002.061.2017281200142.hdf.nc?Cloud_Optical_Thickness_Combined_Mean[0:179][0:359],XDim[0:359],YDim[0:179]"
    ],
    "correct URLs"
);
is_deeply(
