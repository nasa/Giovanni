...
"""
NAME
t_getNcFillValue.py - Unit test script of getNcFillValue.py
...
class testGetNcFillValue(unittest.TestCase):
    def setUp(self):
        self.cmd = "getNcFillValue.py"
    ...
    def testFillValue(self):
        ...
        self.assertEqual(str(output), "-1.26765e+30", "Incorrect fill value")
...
suite = unittest.TestLoader().loadTestsFromTestCase(testGetNcFillValue)
